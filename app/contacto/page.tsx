        ...
        <div className="max-w-[720px] mx-auto px-5">
          <header className="mb-10">
            <div className="flex items-start justify-between gap-4 mb-3">
              ...
              <ShareButton url="/contacto" title="Contacto" variant="button" />
            </div>
          </header>

          <div className="space-y-8 text-base leading-relaxed text-foreground">
            <p className="text-muted-foreground">
              ¿Tienes alguna consulta? Puedes escribirnos por correo, llamarnos o usar el formulario.
            </p>

            <section className="rounded-xl border border-border bg-muted/20 p-6 space-y-4">
              <h2 className="text-xl font-semibold m-0">Datos de contacto</h2>
            ...
            <section>
              <h2 className="text-xl font-semibold mb-4 m-0">Envíanos un mensaje</h2>
