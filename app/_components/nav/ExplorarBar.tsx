  ...
  return (
    <div className="border-b border-border/30 bg-muted/30 dark:bg-muted/10">
      <div className="mx-auto max-w-6xl px-4 py-1.5">
        <div ref={wrapperRef} className="relative mx-auto max-w-md">
            ...
            <div className="absolute left-0 right-0 top-full z-50 mt-1 overflow-hidden rounded-xl border border-border/60 bg-card shadow-lg">
              {results.length > 0 ? (
                    ...
                    <li key={p.id}>
                      ...
                      >
                        {p.foto ? (
                          ...
                          <img src={p.foto} alt="" className="h-9 w-9 shrink-0 rounded-lg object-cover" />
                        ) : (
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="truncate text-[11px] text-muted-foreground">{p.provincia}, {p.comunidad}</p>
                        </div>
                      </Link>
                    </li>
                  ))}
                ...
                <div className="px-3 py-4 text-center text-sm text-muted-foreground">
                  No se encontraron pueblos para &ldquo;{query}&rdquo;
                </div>
              )}
              <Link
                href="/explorar"
              ...
              >
                ...
                Explorar todos los pueblos con filtros avanzados
              </Link>
            </div>
          )}
        </div>
