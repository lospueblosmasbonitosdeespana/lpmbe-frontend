      ...
      <div className="grid grid-cols-1 gap-0 md:grid-cols-[1fr_180px]">
        ...
        <div className="px-6 py-4 md:px-8 md:py-5">
          ...
          <div className="mt-3">
            ...
            ) : filtered.length === 0 && active === "SEMAFORO" ? (
              <div className="rounded-xl border border-emerald-200 bg-emerald-50 px-3 py-2.5">
                <div className="flex items-start gap-2.5">
                  <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-full bg-emerald-500 text-white">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.8" strokeLinecap="round" strokeLinejoin="round" className="h-3.5 w-3.5" aria-hidden="true"><path d="M20 6 9 17l-5-5"/></svg>
                  </span>
                  <div className="min-w-0">
                    <div className="text-sm font-semibold text-emerald-900">{tNotif("allVillagesGreenTitle")}</div>
                    <div className="text-xs text-emerald-800 mt-0.5">{tNotif("allVillagesGreenDesc")}</div>
                  </div>
                </div>
              </div>
            ) : items.length === 0 ? (
