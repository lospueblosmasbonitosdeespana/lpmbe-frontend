...
export default function AppleSignInButton() {
  ...
  // En móvil: enlace directo para evitar que Safari bloquee el redirect del SDK

  const buttonClass =
    'flex w-full items-center justify-center gap-2 rounded-md border border-gray-300 bg-black px-3 py-2.5 text-white hover:bg-gray-900 disabled:opacity-50';
