...
const KEYS_PROTEGIDAS = new Set([
  ...
  'NEGOCIO_ALOJAMIENTO_FREE',
  'NEGOCIO_ALOJAMIENTO_RECOMENDADO',
  'NEGOCIO_ALOJAMIENTO_PREMIUM',
  'NEGOCIO_RESTAURACION_FREE',
  'NEGOCIO_RESTAURACION_RECOMENDADO',
  'NEGOCIO_RESTAURACION_PREMIUM',
  'NEGOCIO_COMERCIO_FREE',
  'NEGOCIO_COMERCIO_RECOMENDADO',
  'NEGOCIO_COMERCIO_PREMIUM',
  'NEGOCIO_SELECTION',
  'POI_VISITADO',
  'POI_PUEBLO_BONUS_S',
  'POI_PUEBLO_BONUS_M',
