...
export default async function RecursosRuralesClubAdminPage() {
      ...
      <div className="mb-6 flex items-start gap-3">
        ...
        <div>
          <h1 className="text-2xl font-bold text-gray-900 sm:text-3xl">
            Recursos rurales del Club
          </h1>
          <p className="mt-1 text-sm text-muted-foreground">
            Vista global de todos los recursos rurales/naturales que pueden
            puntuar a los socios: tanto los que crea cada pueblo como los de la
            asociación. Validación siempre por GPS, sin QR.
          </p>
        </div>
      </div>
