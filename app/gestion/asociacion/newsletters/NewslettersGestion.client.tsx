...
export default function NewslettersGestionClient({ embeddedInShell = false }: { embeddedInShell?: boolean }) {
  ...
  const outerClass = embeddedInShell ? 'w-full' : 'mx-auto max-w-6xl px-6 py-12';
