  ...
  return (
    <main className="mx-auto max-w-4xl p-6">
      ...
      <div className="mb-6 flex flex-col gap-2 border-b border-border/60 pb-6 sm:flex-row sm:items-end sm:justify-between">
        <div>
          <p className="text-xs font-semibold uppercase tracking-wider text-fuchsia-600/90 dark:text-fuchsia-400">
            Redes sociales
          </p>
        ...
        <span className="inline-flex h-10 w-10 flex-shrink-0 items-center justify-center rounded-xl bg-fuchsia-500/10 text-lg text-fuchsia-800 dark:bg-fuchsia-500/15 dark:text-fuchsia-200">
          📱
        </span>
      </div>

      <p className="mb-6 text-sm leading-relaxed text-muted-foreground">
        Instagram, Facebook, X, YouTube, TikTok y web oficial. Solo aparecen en la{" "}
        <span className="font-medium text-foreground">ficha pública</span> las redes con URL
        válida (https recomendado).
      </p>
