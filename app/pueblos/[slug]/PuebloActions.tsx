            ...
            <div className="flex items-center gap-2">
              ...
              {alertasActivasCount > 0 && (
                <Link
                  ...
                  className="inline-flex items-center gap-1 rounded-md px-1.5 py-1 text-amber-700 hover:bg-amber-50"
                ...
                >
                  ...
                  <span className="text-xs font-semibold">{alertasActivasCount}</span>
                </Link>
              )}
            </div>
          </div>
